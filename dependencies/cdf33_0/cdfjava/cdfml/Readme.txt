...
*     - installed/built the CDF distribution package (preferably V3.1).   *
*     - executed the definitions.* file located under the cdf32-dist/bin  *
*       directory (e.g. `source definitions.C' for C shell) to define     *
*       the environment variables (e.g. CDF_BASE, CDF_LIB, etc).          *
...
2. Set the CLASSPATH and LD_LIBRARY_PATH (DYLD_LIBRARY_PATH for Mac OSX)
   ...
   1) CLASSPATH should point to the following information:
      ...
      - the location (full path name) of the parser package if not the
        Sun's Java 1.4.

      Examples: 

      - using the Xerces parsers

         setenv CLASSPATH ${CLASSPATH}:.: \
                          /home/cdf/cdf32-dist/cdfjava/classes/cdfjava.jar: \
                          /home/cdf/cdf32-dist/cdfjava/cdfml/cdfml.jar: \
                          /home/cdf/xml4j-4_0_1/xercesImpl.jar: \
                          /home/cdf/xml4j-4_0_1/xmlParserAPIs.jar

      - using Sun's V1.5

         setenv CLASSPATH ${CLASSPATH}:.: \
                          /home/cdf/cdf32-dist/cdfjava/classes/cdfjava.jar: \
                          /home/cdf/cdfml/cdfml.jar
   ...
   2) LD_LIBRARY_PATH should point to the following information:
      ...
      Example: 
         setenv LD_LIBRARY_PATH .:/home/cdf/cdf32-dist/cdfjava/lib:${CDF_LIB} 

         OR for Mac OSX,
         setenv DYLD_LIBRARY_PATH .:/home/cdf/cdf32-dist/cdfjava/lib:${CDF_LIB}
